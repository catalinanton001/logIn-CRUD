...
<body>
	...
	<div class="container" >
		<h2 class="h2form">Fill all the fields for registration</h2>
		<form action="backautentification.php" method="POST">
			<div class="form-group">
				<input type="text" name="username" class="form-control" placeholder="Insert your username">
				...
				<button type="submit" id="formbutton"  class="btn btn-primary" name="register" >Register</button>
			</div>
		</form>
	</div>
